...
export default function RangeAssistant({
  ...
  raiserBehindJam = false, aggressors, cappedRange, callPressure,
  ...
  const advice = useMemo<UnifiedAdvice | null>(() => {
    ...
    const a = getPostflopAdvice({ hole: [card1, card2], board, pot, toCall, heroStack, effStack, opponents, inPosition, aggression, barrels, bb, villainTier, aggressors, cappedRange, callPressure })
